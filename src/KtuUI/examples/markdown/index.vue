<template lang="html">
    <div
        ...
        ref="markdown"
        :style="{width:editorWidth+'px',height:'100%'}"
    >
        <!-- 头部工具栏 -->
        <ul v-show="preview===1||preview===3" class="markdown-toolbars">
        ...
        <div class="markdown-content" :style="{background:preview==2?'#fff':''}">
            ...
            <div v-show="preview===1||preview===2" :class="`markdown-preview ${themeName}`" ref="preview"
