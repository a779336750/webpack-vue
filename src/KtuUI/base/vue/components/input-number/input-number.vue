        ...
        >
            ...
            >
                <span
                    ...
                    @click="preventDefault"
                >
                    <icon id="#svg-arrow-bottom-1"></icon>
                </span>
            </a>
        </div>
        ...
        wrapClasses() {
            return [
                `${prefixCls}`,
                {
                    ...
                    [`${prefixCls}-lineborder`]: this.lineborder
                }
            ];
        },
        hasHandle() {
            return !this.lineborder && !this.nohandle;
        },
        handlerClasses() {
