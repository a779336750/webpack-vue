...
const prefixCls = "time-picker-cells";
    ...
    computed: {
        ...
        hoursList() {
            ...
            for (let i = 0; i < 24; i += step) {
                ...
                if (
                    this.disabledHours.length &&
                    this.disabledHours.indexOf(i) > -1
                ) {
                    hour.disabled = true;
        ...
        minutesList() {
            ...
            const focusedMinute =
                this.focusedColumn === 1 && this.focusedTime[1];
            const minute_tmpl = {
                text: 0,
                selected: false,
                disabled: false,
        ...
        secondsList() {
            ...
            const focusedMinute =
                this.focusedColumn === 2 && this.focusedTime[2];
            const second_tmpl = {
                text: 0,
                selected: false,
                disabled: false,
            ...
            this.$nextTick(() => {
                timeParts.forEach(type => {
                    this.$refs[type].scrollTop =
                        24 *
                        this[`${type}List`].findIndex(
                            obj => obj.text == this[type]
                        );
                });
            });
        },
