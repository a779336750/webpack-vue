    ...
    <ul :class="[prefixCls + '-list']">
        ...
        >
            <span @click="handlePreview(file)">
                <Icon id="#svg-upload-big"></Icon> {{ file.name }}
            </span>
            <Icon
                iamgeid="close1"
...
export default {
    ...
    methods: {
        ...
        format(file) {
            ...
            if (
                ["gif", "jpg", "jpeg", "png", "bmp", "webp"].indexOf(format) >
                -1
            ) {
                type = "ios-image";
            }
            ...
            if (
                ["mp3", "wav", "wma", "ogg", "aac", "flac"].indexOf(format) > -1
            ) {
                type = "ios-musical-notes";
            }
            if (
                ["doc", "txt", "docx", "pages", "epub", "pdf"].indexOf(format) >
                -1
            ) {
                type = "md-document";
            }
